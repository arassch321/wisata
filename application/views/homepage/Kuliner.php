...
<section class="section-header-single">
	<img src="<?=base_url()?>assets/homepage/img/makanan.jpg">
	<div class="overlay">
...
<section class="section section-discover" id="discover">
	<div class="section-head">
		...
		<h3 class="section-title">KULINER KABUPATEN Indramayu</h3>
		<p class="section-subtitle">Kabupaten Indramayu selain kaya dengan keindahan alamnya juga kaya akan cita rasa kulinernya. Simak dibawah ini daftar kuliner khas <b>Kabupaten Indramayu</b>.</p>
	</div>
